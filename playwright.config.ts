...
// 关键：构建时把 VITE_TICKET_PROXY_BASE_URL 设成 preview 同源地址，使搜索请求落到同源
...
export default defineConfig({
  ...
  webServer: {
    command: `VITE_TICKET_PROXY_BASE_URL=${ORIGIN} npm run build && npm run preview -- --port ${PORT} --strictPort`,
    url: ORIGIN,
